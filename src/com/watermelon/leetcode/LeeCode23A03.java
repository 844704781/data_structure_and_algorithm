...
public class LeeCode23A03 {
    ...
    static class Solution {
        ...
        public ListNode mergeKLists(ListNode[] lists) {
            ...
            List<ListNode> data = new ArrayList<>(Arrays.asList(lists));
            List<ListNode> result = merge(data);
            return result.get(0);
        }
        ...
        private List<ListNode> merge(List<ListNode> lists) {
            ...
            while (i <= j) {
                ...
                ListNode result = mergeSort(lists.get(i++), lists.get(j--));
                all.add(result);
            }
            return merge(all);
        }
