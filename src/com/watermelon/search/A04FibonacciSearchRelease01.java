 ...
 * 斐波那契递归算法
 */
public class A04FibonacciSearchRelease01 extends A00Search {
...
//        int target = 6;
        new A04FibonacciSearchRelease01("fibonacci递归查找").call(arrays, target);
//        System.out.println(Arrays.toString(fibs(100)));
    }

    public A04FibonacciSearchRelease01(String name) {
        super(name);
    }
